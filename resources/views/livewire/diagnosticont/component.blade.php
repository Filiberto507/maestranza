<div class="row sales layout-top-spacing">
                    ...
                    <table class="table table-bordered table striped mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" wire:click="Edit({{$diag->id}})" class="btn btn-dark mtmoble" title="Editar Registro">
                                    ...
                                    @can('vista_eliminar')
                                    <a href="javascript:void(0)" onclick="Confirm('{{$diag->id}}')" class="btn btn-dark" title="Eliminar Registro">
                                    ...
                                    @endcan
                                    <a href="{{ url('diagnosticont/pdf' . '/' . $diag->id) }}" class="btn btn-danger" target="_blank">
    ...
    @include('livewire.diagnosticont.form')
</div>
